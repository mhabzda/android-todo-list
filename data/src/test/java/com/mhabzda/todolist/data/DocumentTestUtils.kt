...
private const val CREATION_DATE_TIME_KEY = "creationDate"
...
fun mockDocument(
    ...
    mock {
        ...
        on { getString(CREATION_DATE_TIME_KEY) } doReturn creationDateTime
...
fun createDocumentMap(
    ...
    creationDateTime?.let { map[CREATION_DATE_TIME_KEY] = it }
    return map
}
...
fun mockDocumentFromMap(documentMap: Map<String, String>): DocumentSnapshot =
    mock {
        ...
        on { getString(CREATION_DATE_TIME_KEY) } doReturn documentMap[CREATION_DATE_TIME_KEY]
